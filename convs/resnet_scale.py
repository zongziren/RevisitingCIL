...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        print('Using ResNet with scale & bias')
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        ...
        # scale layer
        self.ssf_scale_1, self.ssf_shift_1 = init_ssf_scale_shift(self.out_dim)
    ...
    def _forward_impl(self, x):
        ...
        features= ssf_ada(features, self.ssf_scale_1, self.ssf_shift_1)
        return {
...
def resnet18_scale(pretrained=False, progress=True, **kwargs):
...
def resnet34_scale(pretrained=False, progress=True, **kwargs):
...
def resnet50_scale(pretrained=False, progress=True, **kwargs):
...
def resnet101_scale(pretrained=False, progress=True, **kwargs):
...
def resnet152_scale(pretrained=False, progress=True, **kwargs):
